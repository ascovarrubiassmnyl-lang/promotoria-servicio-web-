        ...
        <Card className="lg:col-span-2" title="Evaluador de prospectos" subtitle="La lista para calificar y llamar en la clínica.">
          {isLoading ? (
            ...
            <div className="space-y-3">
              <EmptyState message="Sin prospectos esta semana. Agrega los contactos que llamarás en la clínica." />
              <button onClick={() => { setProspectoEdit(null); setModalOpen(true); }} className="btn-primary text-xs">+ Agregar prospecto</button>
            </div>
          ) : (
