...
import { Card, VentaBadge, EmptyState } from '../ui.jsx';
import {
    ...
    <div className="space-y-4">
      ...
      <Card>
            ...
            <div className="flex justify-end gap-2">
              ...
              {readOnly ? (
                ...
                <>
                  ...
                  {puedeRegistrarPago && (
                    <button onClick={confirmarCobro} className="btn-primary text-xs py-1.5 px-2.5">Registrar pago</button>
                  )}
                </>
              )}
            </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-x-6 gap-y-5">
          ...
          <Kv k="Próximo pago">{p.fechaProximoPago ? fechaCorta(p.fechaProximoPago) : '—'}</Kv>
